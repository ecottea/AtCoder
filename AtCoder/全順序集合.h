...
using S701 = ll;
bool leq701(S701 a, S701 b) { return a <= b; }
S701 inf701() { return INFL; }
#define Ascending_toset S701, leq701, inf701


//【降順 全順序集合】
/* verify : https://atcoder.jp/contests/abc228/tasks/abc228_f */
using S702 = ll;
bool leq702(S702 a, S702 b) { return a >= b; }
S702 inf702() { return -INFL; }
#define Descending_toset S702, leq702, inf702
