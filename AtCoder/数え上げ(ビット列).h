...
//【ビット列の数え上げ（1 の数指定，転倒数ごと）】
/*
* 長さ n のビット列で 1 を r 個含み，転倒数が k であるものの個数は q-二項係数を用いて
*	[q^k] nCr_q
*	= [q^k] (Πi∈[n-k+1..n] (1 - q^i)) / (Πi∈[1..k] (1 - q^i))
* と表される．
* 
*（証明）ビット列を 1 つ伸ばすとどうなるかを考えて導出される漸化式が，
* q-二項係数の満たす漸化式（パスカルの三角形の規則）と一致する．
*/
