...
//【箱根駅伝 DP】
/*
* [0..n) の順列と，部集合 S=[0..n), T=[0..n) 間の完全マッチングとは 1:1 に対応する．
* この解釈だと S と T を対等に扱えるので，遷移を考えやすくなる場合がある．
* 
...
//【順列の数え上げ（転倒数ごと）】
/*
* [0..n) の順列で転倒数が k であるものの個数は，q-階乗を用いて
*	[q^k] [n]_q !
*	= [q^k] (Πi∈[1..n] (1 - q^i)) / (1 - q)^n
* で表される．
* 
*（証明）要素の大きさ順での挿入 DP を考えて得られる漸化式が，q-階乗の表式
*	[n]_q ! = 1 (1 + q) (1 + q + q^2) ... (1 + q + ... + q^(n-1))
* と対応する．
*/
